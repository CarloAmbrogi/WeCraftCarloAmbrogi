<?php
  ...
  //Add a carosuel with the imges of this project (if there are no images for this project, the carousel is not shown)
  function addCarouselImagesOfThisProject($projectId){
    $numberOfImages = getNumberImagesOfThisProject($projectId);
    if($numberOfImages > 0){
      $images = getImagesOfThisProject($projectId);
      ?>
        <div id="carouselExampleIndicators" class="carousel slide">
          <div class="carousel-indicators">
            <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
