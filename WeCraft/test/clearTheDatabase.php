<?php
  ...
  if($possibilityToExecuteThisScript == true){
    ...
    mysqli_query($connection, "TRUNCATE TABLE `my_carloambrogipolimi`.`ContentRecentOrder`");
    ...
    mysqli_query($connection, "TRUNCATE TABLE `my_carloambrogipolimi`.`RecentOrders`");
