<?php
  ...
  if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    upperPartOfThePage(translate("Sell exchange product"),"./product.php?id=".$insertedProductId);
    ...
    if(isset($_GET["id"])){
      upperPartOfThePage(translate("Sell exchange product"),"./product.php?id=".$_GET["id"]);
